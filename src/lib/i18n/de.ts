export const de = {
  ...
  landing: {
    ...
    hero_subtitle: 'Übe Voicings, bis sie Muskelgedächtnis sind. Shells, rootless, ii-V-I — flüssig in allen 12 Tonarten, eine kurze Session nach der anderen.',
    hero_subtitle_mobile: 'Übe Jazz-Voicings, bis sie sitzen.',
    hero_no_midi: 'MIDI-Keyboard da? Es prüft dich automatisch. Keins? Nimm dein Mikrofon oder check selbst. Deine Wahl.',
    ...
    coach_desc: 'Nie wieder überlegen, was du üben sollst. Ein kurzer Akkord-Check findet heraus, wo du stehst — danach wird jede Session für dich gebaut: aufwärmen mit dem, was du kannst, Fälliges wiederholen, an deiner Schwachstelle arbeiten, eine neue Sache lernen und sie in einer echten Progression anwenden.',
    coach_b1_t: 'Holt dich ab, wo du stehst',
    coach_b1_d: 'Ein Drei-Minuten-Check ordnet dich ein. Du spielst schon Shells? Dann überspringst du sie — kein Anfänger-Laufband.',
    coach_b2_t: 'Passt sich jeder Session an',
    coach_b2_d: 'Läuft es? Die nächste Stufe schaltet frei. Hakt es? Der Coach bleibt genau da und übt, was schwerfällt — bis es sitzt.',
    coach_b3_t: 'Erweitert deinen Radius',
    coach_b3_d: 'Neue Tonarten, neue Voicings, neue Farben — Schritt für Schritt, bis sich alle 12 Tonarten wie zuhause anfühlen.',
    coach_mock_say: 'Heute: Shell-Voicings auffrischen, dann E♭maj7 in neuen Tonarten — 12 Minuten.',
    ...
    coach_mock_b4: 'Neu · E♭maj7 in mehr Tonarten',
    ...
    cur_desc: 'Das sind keine Akkord-Karteikarten. Es ist das Werkzeug arbeitender Jazz-Pianisten — Voicing für Voicing, jedes durch alle 12 Tonarten.',
    cur_now: 'gerade dran',
    ...
    cur_foot: 'Dein Coach schaltet die nächste Stufe frei, wenn die aktuelle sitzt — nicht vorher, und nicht eine Woche später.',
    listen_eyebrow: 'Sofortiges Feedback',
    listen_title: 'Es zeigt dir nicht nur Akkorde. Es hört, wie du sie spielst.',
    listen_desc: 'Schließ ein MIDI-Keyboard an und jeder Akkord wird beim Spielen geprüft — oktav-tolerant, Extranoten verziehen, automatisch weiter, sobald er sitzt. Kein Keyboard da? Nimm dein Mikrofon oder die Bildschirm-Tasten.',
    ...
    habit_desc: 'Dein Tagesziel passt zwischen Kaffee und Arbeit. Streaks und Level halten dich dran — und nach jeder Session sagt dir der Coach in klaren Worten, was besser geworden ist und was als Nächstes kommt. Nichts planen, nichts tracken. Einfach hinsetzen und spielen.',
    habit_stat1: 'Tage Streak',
    habit_stat2: 'Minuten heute',
    habit_stat3: 'Comper',
    habit_quote: '„E♭maj7 ist 31 % schneller als letzte Woche. Morgen nehmen wir uns B♭7 nochmal vor — der hat heute gewackelt."',
    habit_quote_label: 'Feedback nach der Session',
    faq_title: 'Fragen, beantwortet',
    faq1_q: 'Was ist ein Jazz-Piano-Voicing?',
    faq1_a: 'Ein Voicing ist eine bestimmte Anordnung der Töne eines Akkords. Statt alles vom Grundton aufzustapeln, nutzen Jazz-Pianisten Shells (Grundton, Terz, Septime), Rootless-Voicings und Umkehrungen für einen volleren, professionellen Klang. Sie in allen 12 Tonarten zu beherrschen ist das Fundament des Jazz-Pianos — genau das baut der Coach Schritt für Schritt auf.',
    faq2_q: 'Muss ich schon Jazz können?',
    faq2_a: 'Nein. Wenn du Töne auf dem Keyboard findest, startet der Coach mit einfachen Shell-Voicings in leichten Tonarten und erklärt jeden neuen Sound, sobald er auftaucht. Spielst du schon, überspringt dich der Einstiegs-Check automatisch nach vorn.',
    faq3_q: 'Kann ich mit einem MIDI-Keyboard üben?',
    faq3_a: 'Ja — per USB oder Bluetooth verbinden (Chrome oder Edge am Desktop), und die App erkennt deine Voicings in Echtzeit, oktav-tolerant und mit Nachsicht bei Extranoten. Kein MIDI? Mikrofon oder Bildschirm-Tasten gehen auch.',
    faq4_q: 'Wie viel Zeit brauche ich?',
    faq4_a: 'Fünf Minuten am Tag sind eine echte Session — Warm-up, Wiederholung, eine neue Sache. Du legst dein Tagesziel einmal fest, und der Coach schneidet jede Session darauf zu. Regelmäßigkeit schlägt Marathon-Üben, und genau darum ist das Streak-System gebaut.',
