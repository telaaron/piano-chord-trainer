export const de = {
  ...
  landing: {
    ...
    hero_subtitle: 'Lerne Akkorde am Klavier — Schritt für Schritt, mit sofortigem Feedback. Für Anfänger mit Grundkenntnissen bis Fortgeschrittene.',
    hero_subtitle_mobile: 'Akkorde lernen am Klavier — mit sofortigem Feedback.',
    hero_no_midi: 'MIDI-Keyboard, Audio-Erkennung per Mikrofon oder manuelle Selbstbewertung — du entscheidest, wie du übst.',
    badge: 'MIDI · Audio · Übe-Statistik',
    cta_start: 'Training starten',
    cta_learn: 'Kurs starten',
    cta_educators: 'Für Musikschulen',
    footnote: 'Kostenlos. Keine Anmeldung. Auch ohne MIDI-Keyboard.',
    footnote_mobile: 'Kostenlos · Ohne Anmeldung · Kein MIDI nötig',
