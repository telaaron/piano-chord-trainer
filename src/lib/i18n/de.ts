export const de = {
  ...
  pricing: {
    ...
    heading: 'Pläne & Preise',
    subheading: 'Starte kostenlos. Upgrade wenn du bereit bist für mehr.',
    per_month: 'Monat',
    free: 'Kostenlos',
    pro: 'Pro',
    educator: 'Educator',
  ...
  terms: {
    ...
    p_subscriptions: 'Wenn Bezahlpläne eingeführt werden, werden Abonnements monatlich oder jährlich über Stripe abgerechnet. Du kannst jederzeit kündigen. Rückerstattungen werden gemäß den geltenden Verbraucherschutzgesetzen behandelt. EU-Verbraucher haben ein 14-tägiges Widerrufsrecht für digitale Dienste.',
    h_data: 'Deine Daten',
