export const en = {
  ...
  landing: {
    ...
    hero_subtitle: 'Drill voicings until they are muscle memory. Shells, rootless, ii-V-I — fluent in all 12 keys, one short session at a time.',
    hero_subtitle_mobile: 'Drill jazz voicings until they are muscle memory.',
    hero_no_midi: 'Have a MIDI keyboard? It auto-checks you. No keyboard? Use your mic or self-check. Your call.',
    ...
    coach_desc: "No more wondering what to practice. A quick chord check finds where you stand — then every session is built for you: warm up with what you know, review what's due, work your weak spot, learn one new thing, and put it to use in a real progression.",
    coach_b1_t: 'Starts where you are',
    coach_b1_d: 'A three-minute check places you on the map. Already play shells? You skip ahead — no beginner treadmill.',
    coach_b2_t: 'Adapts every session',
    coach_b2_d: "Cruising? The next level unlocks. Struggling? The coach stays right there and drills what's hard until it isn't.",
    coach_b3_t: 'Grows your range',
    coach_b3_d: 'New keys, new voicings, new colors — one step at a time, until all 12 keys feel like home.',
    coach_mock_say: 'Today: refresh shell voicings, then E♭maj7 in new keys — 12 minutes.',
    ...
    coach_mock_b4: 'New · E♭maj7 in more keys',
    ...
    cur_desc: "This isn't chord flashcards. It's the working jazz pianist's toolkit — voicing by voicing, each one taken through all 12 keys.",
    cur_now: 'in progress',
    ...
    cur_foot: "Your coach unlocks the next step when the current one sits — not before, and not a week later.",
    listen_eyebrow: 'Instant feedback',
    listen_title: "It doesn't just show you chords. It hears you play them.",
    listen_desc: "Connect a MIDI keyboard and every chord is checked as you play — octave-tolerant, extra notes forgiven, auto-advance when you nail it. No keyboard around? Use your microphone, or tap the on-screen keys.",
    ...
    habit_desc: "Your daily goal fits between coffee and work. Streaks and levels keep you showing up — and after every session the coach tells you, in plain words, what got better and what comes next. Nothing to plan, nothing to track. Just sit down and play.",
    habit_stat1: 'Day streak',
    habit_stat2: 'Minutes today',
    habit_stat3: 'Comper',
    habit_quote: '“E♭maj7 is 31% faster than last week. Tomorrow we revisit B♭7 — it wobbled today.”',
    habit_quote_label: 'After-session feedback',
    faq_title: 'Questions, answered',
    faq1_q: 'What is a jazz piano voicing?',
    faq1_a: 'A voicing is a specific arrangement of the notes in a chord. Instead of stacking everything from the root, jazz pianists use shells (root, 3rd, 7th), rootless voicings and inversions for a richer, professional sound. Mastering them in all 12 keys is the foundation of jazz piano — and exactly what the coach builds, step by step.',
    faq2_q: 'Do I need to know jazz already?',
    faq2_a: "No. If you can find notes on a keyboard, the coach starts you with simple shell voicings in easy keys and explains each new sound as it appears. If you already play, the initial check skips you ahead automatically.",
    faq3_q: 'Can I practice with a MIDI keyboard?',
    faq3_a: 'Yes — connect it via USB or Bluetooth (Chrome or Edge on desktop) and the app recognizes your voicings in real time, with octave tolerance and lenient matching. No MIDI? The microphone or on-screen keys work too.',
    faq4_q: 'How much time do I need?',
    faq4_a: 'Five minutes a day is a real session — warm-up, review, one new thing. You set your daily goal once and the coach sizes every session to fit it. Consistency beats marathon practice, and the streak system is built around exactly that.',
    faq5_q: 'Is it free?',
  ...
  pricing: {
    ...
    offer_trial_title: '14 days free',
    offer_trial_desc: 'Full Pro access. No charge until the trial ends.',
    ...
    faq_educator_q: 'How does the Educator plan work?',
    faq_educator_a: 'The Educator plan lets you embed the trainer on your website and track student progress. Contact us for a demo.',
