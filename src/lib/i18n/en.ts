export const en = {
  ...
  terms: {
    ...
    h_subscriptions: 'Subscriptions & Payments',
    p_subscriptions: 'When paid plans are introduced, subscriptions will be billed monthly or annually through Stripe. You may cancel at any time. Refunds are handled according to applicable consumer protection laws. EU consumers have a 14-day withdrawal right for digital services.',
    h_data: 'Your Data',
