export const en = {
  quickstart: {
    ...
    warmup_title: 'Daily warm-up',
    warmup_desc: 'Shell voicings, ii-V-I — ease in.',
    weakspots_title: 'Weak spots',
    weakspots_desc: 'Adaptive drill on your slowest chords.',
    iivi_title: 'ii-V-I',
    iivi_desc: 'The core jazz cadence in all keys.',
    cycle_desc: 'Move roots through all 12 keys, in fourths.',
    speed_desc: 'Beat the clock — random chords, no hints.',
    start_custom: 'Start with current settings',
    customize: 'Customize',
    coach_hero_title: 'Keep practicing',
    coach_hero_sub: 'Your coach builds today\'s session.',
    pick_yourself: 'Pick it yourself',
  },
  coach: {
    // Block announcements (transition screen). Params in braces.
    block: {
      warmup: 'Warm up with {voicing}',
      review: 'Refresh {count} chords',
      focus: 'Focus: {root} in {voicing}',
      new: 'New: {quality} in {voicing}',
    ...
    // Short confirmation of the finished block (transition screen, no params).
      ...
      review: 'Refreshed',
      focus: 'Focus done',
      new: 'New material practiced',
      apply: 'Applied',
      calibrate: 'Check done',
    },
    // Coach announcement on the hero button.
    say: {
      calibrate: 'First a quick check — {chords} chords, then we begin.',
      short: 'Today: refresh {voicing} and dig into {quality} — {minutes} minutes.',
      full: 'Today: warm up, firm up {focusRoot}, and {quality} in {voicing} is new — {minutes} minutes.',
      reviewOnly: 'Just a refresh today — {minutes} minutes and you\'re back on track.',
    },
    // Teacher feedback after the session. {tier} names the key stage so
    // "already have it" and "next goal" never sound contradictory.
    fb: {
      promoted: '{quality} in {voicing} {tier} sits now — cleanly mastered.',
      held: 'We\'ll take another pass at {quality} in {voicing} {tier} — it\'s coming.',
      demoted: 'Easing {quality} in {voicing} {tier} down a step — no worries.',
      improved: 'Noticeably faster: avg {avgMs} ms per chord.',
      placed: 'You already have {quality} in {voicing} {tier} — skipped ahead.',
      nextGoal: 'Next goal: {quality} in {voicing} {tier}.',
      calibrated: 'Check done — {placed} building blocks already in place.',
    },
  ...
  settings: {
    ...
    quick_controls_label: 'Quick Controls',
    quick_controls_title: 'Set up your next focused session',
    quick_controls_desc: 'Start immediately, open insights, or adjust training in one place.',
    trainer_hub_label: 'Trainer Hub',
    trainer_hub_title: 'Everything you need before deep focus',
    trainer_hub_member: 'Signed in',
    trainer_hub_guest: 'Guest mode',
    trainer_hub_next: 'Next:',
    trainer_hub_next_learn: 'Learn',
    show_insights: 'Show Insights',
    hide_insights: 'Hide Insights',
    start_practicing: 'Start practicing',
    start_practicing_sub: 'Pick a focused session — or tweak the details below.',
    back_to_home: 'jazzchords.app',
    open_settings: 'Settings',
    how_it_works_goal: 'The goal: play every chord in all 12 keys — without thinking.',
    how_it_works_steps: 'How: short drills · instant feedback · weak keys targeted.',
    more_plans: 'More plans',
    fewer_plans: 'Fewer plans',
  ...
  results: {
    ...
    drill_weak: 'Drill your weak spots',
    drill_weak_desc: 'A focused drill on the chords you were slowest at.',
  ...
  landing: {
    hero_title: 'Play Any Jazz Chord, in Any Key — Without Thinking',
    hero_title_html: '<span class="gradient-text">Play Any Jazz Chord,</span> <span class="white-text">in Any Key — Without Thinking</span>',
    hero_title_line1: 'Play any jazz chord,',
    ...
    coach_desc: 'A quick check finds where you stand. Every session after that is built for you.',
    coach_b1_t: 'Starts where you are',
    coach_b1_d: 'Already play shells? You skip ahead.',
    coach_b2_t: 'Adapts every session',
    coach_b2_d: "Struggling? The coach stays right there until it sits.",
    coach_b3_t: 'Grows your range',
    coach_b3_d: 'One step at a time, until all 12 keys feel like home.',
    coach_mock_say: 'Today: refresh shell voicings, then Maj7 in new keys — 12 minutes.',
    coach_mock_btn: 'Keep practicing',
    coach_mock_b1: 'Warm-up · what you know',
    coach_mock_b2: 'Review · chords due today',
    coach_mock_b3: 'Focus · B♭7 shell',
    coach_mock_b4: 'New · Maj7 in more keys',
    coach_mock_b5: 'Apply · ii-V-I in B♭',
    coach_mock_fb: '“B♭7 shell sits now — next up: rootless voicings.”',
    coach_mock_fb_label: 'Your coach, after the session',
    cur_eyebrow: 'The real thing',
    cur_title: 'The same road a good teacher takes you down',
    cur_desc: "The working jazz pianist's toolkit — voicing by voicing, through all 12 keys.",
    cur_now: 'in progress',
    cur_s1_t: 'Shell voicings',
    cur_s1_d: 'Root, 3rd and 7th — the skeleton of jazz harmony',
    cur_s2_t: '6th & 9th colors',
    cur_s2_d: 'The first color notes that make chords sound like jazz',
    cur_s3_t: 'Rootless voicings',
    cur_s3_d: 'The Bill Evans sound — what pros actually play',
    cur_s4_t: 'Inversions & voice leading',
    cur_s4_d: 'Move between chords with barely moving your hand',
    ...
    habit_desc: "Nothing to plan, nothing to track. Just sit down and play.",
    habit_stat1: 'Day streak',
    habit_stat2: 'Minutes today',
    habit_stat3: 'Comper',
    habit_quote: '“E♭maj7 is 31% faster than last week. Tomorrow, B♭7 again.”',
    habit_quote_label: 'After-session feedback',
    faq_title: 'Questions, answered',
    faq1_q: 'What is a jazz piano voicing?',
    faq1_a: 'A specific arrangement of the notes in a chord. Instead of stacking from the root, jazz pianists play shells, rootless voicings and inversions — in all 12 keys.',
    ...
    faq5_q: 'Is it free?',
    faq5_a: 'Yes. Every training feature, no account needed. An optional Pro plan adds cloud sync and deeper statistics.',
    cta2_title: 'Your coach is ready when you are.',
    cta2_desc: 'The first session takes three minutes.',
    // ── The key clock section ──
    clock_eyebrow: 'The twelve keys',
    clock_title: 'Everyone avoids five keys. Yours are on this dial.',
    clock_desc: 'The ring grows outward where your hands hesitate. Untouched keys stay hollow.',
    ...
    pcard_live: 'Live',
    pcard_head: 'Session · Focus · B♭7 shell',
    pcard_step_ask: '1 · Asked',
    pcard_chord: 'B♭7',
    pcard_voicing_name: 'Shell',
    pcard_voicing_notes: '3rd + 7th',
    pcard_step_answer: '2 · Your answer',
    pcard_kbd_alt: 'Keyboard: B♭, D and A♭ are pressed — the shell voicing of B♭7',
    pcard_verdict: 'Nailed it. Next chord.',
    pcard_time_label: 'Your time',
    pcard_bar_last: 'Last week',
    pcard_bar_today: 'Today',
    // Illustrative times. Decimal point, not comma, in English.
    ...
    twitter_title: 'Chord Trainer – Become Fluent in Jazz Piano Voicings',
    twitter_desc: 'Drill jazz voicings until automatic — fluent in all 12 keys. Instant feedback, weak-spot targeting, guided plans.'
  },
  ...
  ui: {
    ...
    history_window_hint: 'Showing the last {days} days. {count} older sessions are kept, not deleted. ',
    sessions_label: 'Last {n} sessions',
    seconds_per_chord: 'Seconds per chord',
    older: 'Older',
    vs_before: '{pct}% vs. before',
    sessions_until_chart: '{n} more session until your chart appears',
    sessions_until_chart_plural: '{n} more sessions until your chart appears',
    insights_empty_title: 'Your stats fill up over time',
    insights_empty_desc: 'Play your first session — then you will see your speed, weakest keys, and how you improve, right here.',
    insights_empty_cta: 'Start your first session',
    ...
    tap_build: 'Build the chord on the keys, then Check',
  ...
  privacy: {
    ...
    li_no_cookies: 'No tracking cookies (only essential auth cookies if logged in)',
    ...
    td_supabase_purpose: 'Authentication & cloud data storage (optional, only with account)',
    td_stripe_purpose: 'Payment processing (only for paid plans)',
    td_link: 'Link',
    
    h_rights: '4. Your Rights (GDPR)',
    p_rights: 'Under the General Data Protection Regulation (GDPR), you have the right to:',
    li_access: '<strong>Access</strong> your data — all practice data is in your browser\'s localStorage. With an account, you can also access your cloud data through your account settings.',
    li_delete: '<strong>Delete</strong> your data — clear your browser data or delete your account. Account deletion removes all cloud-stored data.',
    li_portability: '<strong>Portability</strong> — your browser\'s developer tools can export localStorage. Account data can be downloaded through your account settings.',
  ...
  habit: {
    ...
    // The dial as a reward — a key is fluent once it sits under the threshold.
    xp_key_fluent: '{key} is fluent',
    xp_circle_milestone: '{count} of 12 keys fluent',
    xp_circle_complete: 'All twelve keys are fluent.',
  ...
  learn: {
    ...
    practice_guided_interval: 'Play the interval — both keys are highlighted.',
    practice_find: 'Find the interval! Only the root is marked — count the semitones.',
    ...
    challenge_interval_intro: 'Speed drill: Find {label} from each root across {count} keys — under {threshold}ms per interval to pass.',
    challenge_go: 'Go!',
  ...
  auth: {
    ...
    login_subheading: 'Sign in to sync your progress across devices.',
    signup_subheading: 'Free account — sync your practice data across all your devices.',
    reset_subheading: 'Enter your email and we\'ll send you a reset link.',
    sync_hint: 'With an account, your progress, streaks, and settings sync across all your devices. Practice on your laptop, check stats on your phone.',
    email: 'Email',
    password: 'Password',
    ...
    merge_local_data: 'Transfer my existing practice data (sessions, streaks, course progress) into my account',
    ...
    legal_notice: 'By creating an account, you agree to our <a href="/terms" class="underline">Terms of Service</a> and <a href="/privacy" class="underline">Privacy Policy</a>.',
  ...
  account: {
    ...
    not_logged_in: 'You\'re not logged in. Sign in to manage your account and sync your progress.',
    profile: 'Profile',
    progress: 'Your progress',
    member_since: 'Member since',
    display_name: 'Display name',
    display_name_placeholder: 'Your name',
    display_name_saved: 'Display name saved.',
    change_password: 'Change password',
    new_password: 'New password',
    save: 'Save',
    password_changed: 'Password changed successfully.',
    subscription: 'Subscription',
    beta_active: 'Beta — Everything Free!',
    beta_description: 'During the beta phase, all Pro features are available for free. Enjoy!',
    ...
    cloud_sync_desc: 'Sync your practice data between devices. Upload sends your current data to the cloud, download restores from your last upload.',
    upload_to_cloud: 'Upload to Cloud',
    download_from_cloud: 'Download from Cloud',
    sync_success: 'Data uploaded to cloud successfully!',
    download_success: 'Cloud data restored successfully! Reload to see changes.',
    no_cloud_data: 'No cloud data found for your account.',
    privacy: 'Anonymous Usage Data',
    privacy_desc: 'Helps us improve the practice coach — fully anonymous, no personal data, and you can turn it off anytime.',
    privacy_toggle_label: 'Share anonymous usage data',
  ...
  pricing: {
    title: 'Pricing',
    meta_desc: 'Pricing plans for jazzchords.app. Free tier with all courses. Pro tier with advanced features.',
    heading: 'Become fluent in every key.',
    subheading: 'Everything you need to practise is free. Studio is for playing more of it — every day, without a limit.',
    per_month: 'month',
    per_year: 'year',
    billing_label: 'Billing period',
    billing_yearly: 'Yearly',
    billing_monthly: 'Monthly',
    billing_save: 'save up to 38%',
    studio: 'Studio',
    lehrpult: 'Lehrpult',
    institut: 'Institut',
    studio_yearly_note: '€4.92 a month, billed yearly',
    lehrpult_yearly_note: '€24.17 a month, billed yearly',
    institut_from: 'from €490',
    ...
    feat_assignments: 'Set assignments for your students',
    feat_everything_lehrpult: 'Everything in Lehrpult',
    feat_invoice: 'Payment by invoice',
    plans_eyebrow: 'The four plans',
    cta_pro_trial: 'Start 7 days free',
    pro_trial_note: 'no card needed · then the plan price · cancel anytime',
    // ── Grand-slam risk reversal ──
    offer_title: 'Zero risk. All upside.',
    offer_subtitle: 'We are certain this makes you a faster player. So we carry the risk, not you.',
    offer_trial_title: '7 days free',
    offer_trial_desc: 'Full Studio access, no card required. Nothing to cancel if you walk away.',
    offer_guarantee_title: '30-day money-back',
    offer_guarantee_desc: 'Not happy? Email us within 30 days for a full refund. No questions.',
    offer_speed_title: 'Speed guarantee',
    offer_speed_desc: 'Practice 5 min/day and if you are not noticeably faster across all 12 keys in 30 days, we refund you.',
    offer_cancel_title: 'Cancel anytime',
    offer_cancel_desc: 'One click in your account. No emails, no hoops, no lock-in.',
    // ── Feedback ──
    feedback_title: 'Built with you.',
    feedback_desc: 'We\'re actively shipping. Got a feature idea, a voicing we\'re missing, or feedback? Write us — we read every message and add what players ask for.',
    feedback_cta: 'Email us',
    free: 'Free',
    pro: 'Pro',
    educator: 'Educator',
    institution: 'Institution',
    popular: 'Most Popular',
    beta_free: 'Free in Beta',
    coming_soon: 'Coming Soon',
    beta_banner_title: 'Beta Phase – Everything is Free!',
    beta_banner_desc: 'We\'re currently in beta. All features are free while we refine the experience. Paid plans will launch later.',
    cta_free: 'Start Training',
    cta_pro: 'Get Pro',
    cta_educator: 'Join the waiting list',
    waitlist_note: 'In build. Tell us what you need and we will let you know the moment it is ready — early sign-ups get the first year at this price.',
    waitlist_tag: 'Soon',
    cta_institution: 'Contact Us',
    ...
    feat_adaptive: 'Adaptive difficulty',
    feat_all_voicings: 'All 9 voicing types',
    feat_voice_leading: 'Voice leading analysis',
    feat_custom_progressions: 'Custom progressions',
    feat_advanced_stats: 'Advanced statistics',
    feat_cloud_sync: 'Cloud sync across devices',
    feat_everything_pro: 'Everything in Pro',
    feat_embed: 'Embed widget for your site',
    feat_student_progress: 'Student progress dashboard',
    feat_30_students: 'Up to 30 students',
    feat_everything_educator: 'Everything in Educator',
    feat_custom_branding: 'Custom branding',
    feat_lms: 'LMS integration (LTI)',
    feat_api: 'API access',
    feat_sso: 'Single sign-on (SSO)',
    feat_unlimited_students: 'Unlimited students',
    faq_heading: 'Frequently Asked Questions',
    faq_beta_q: 'What does beta mean?',
    faq_beta_a: 'We\'re still improving the platform. During beta, all features including Pro features are completely free. When we launch paid plans, you\'ll get plenty of notice.',
    faq_data_q: 'What happens to my data?',
    faq_data_a: 'Your practice data is stored locally in your browser. With an account, you can sync it across devices. You can export or delete your data at any time.',
    faq_cancel_q: 'Can I cancel anytime?',
    faq_cancel_a: 'Yes, you can cancel your subscription at any time. You\'ll keep access until the end of your billing period.',
    faq_educator_q: 'How does the Lehrpult plan work?',
    faq_educator_a: 'Lehrpult is being built. It will give you up to 30 student seats with full Studio access, a dashboard showing how each of them is getting on, assignments you can set, and an embed widget for your own site. You cannot buy it yet — join the waiting list and we will let you know the moment it is ready. Tell us how you teach while you are at it; it shapes what we build.',
    faq_trial_q: 'How does the free trial work?',
    faq_trial_a: 'You get 7 days of full Studio access and we do not ask for a card. When the week is up the trial simply ends — there is nothing to cancel and nothing is charged. If you want to carry on, you add a payment method then.',
  ...
  upgrade: {
    ...
    cta_trial: 'Start 7 days free',
    cta_login: 'Sign in to upgrade',
    later: 'Maybe later',
    trial_note: 'no card needed · then €7.99/mo · cancel anytime',
    // teaser (after first free taste)
    teaser_adaptive_title: 'That was Adaptive Coaching.',
    teaser_adaptive_desc: 'It found the keys slowing you down and drilled exactly those. Keep it working for you with Studio.',
    teaser_stats_title: 'This is your full progress picture.',
    teaser_stats_desc: 'Trends, your slowest chords, every personal best. Keep the deep insights with Studio.',
    // direct lock
    lock_sessions_title: 'That\'s today\'s session done.',
    lock_sessions_desc: 'The free plan includes one coached session a day. Free practice stays open — or take Studio and practise as often as you like.',
    lock_togo_title: 'Unlock all seven To-Go disciplines',
    lock_togo_desc: 'Sing, time, licks and progressions — the four that train what your hands alone can\'t.',
    lock_history_title: 'Unlock your full history',
    lock_history_desc: 'The free plan shows the last 7 days. Nothing is deleted — Studio brings all of it back.',
    ...
    lock_generic_title: 'Unlock with Studio',
    lock_generic_desc: 'This is a Studio feature. Try everything free for 7 days.',
  },
  ...
  nav_auth: {
    ...
    account: 'Account',
    pricing: 'Pricing',
    sync_banner: 'Sync across devices',
    sync_banner_desc: 'Create a free account to sync your progress across all your devices.',
    sync_banner_cta: 'Create Account',
    sync_banner_dismiss: 'Not now',
  ...
  terms: {
    ...
    meta_desc: 'Terms of Service for jazzchords.app',
    h1: 'Terms of Service',
    last_updated: 'Last updated: March 2026',
    intro: 'These Terms of Service ("Terms") govern your use of jazzchords.app ("Service"), operated by Aaron Technologies OÜ ("we", "us").',
    h_acceptance: 'Acceptance of Terms',
    p_acceptance: 'By accessing or using our Service, you agree to these Terms. If you do not agree, do not use the Service.',
    h_service: 'Description of Service',
    p_service: 'jazzchords.app is a web-based jazz piano practice tool that helps musicians learn and practice chord voicings, progressions, and ear training through interactive exercises.',
    h_accounts: 'User Accounts',
    p_accounts: 'You may use the Service without an account. Creating an account is optional and enables cloud sync of your practice data across devices. You are responsible for maintaining the confidentiality of your account credentials.',
    h_free: 'Free Use & Beta',
    p_free: 'The Service is currently in beta. All features are currently available for free. We reserve the right to introduce paid subscription plans in the future. Existing free users will be given advance notice of any changes.',
    h_subscriptions: 'Subscriptions, Trial & Refunds',
    p_subscriptions: 'The Studio plan is billed through Stripe at €7.99/month or €59/year, and the Lehrpult plan at €29/month or €290/year (each incl. applicable VAT). New subscriptions start with a 7-day free trial; no payment method is required to begin the trial and nothing is charged during it. If no payment method has been added when the trial ends, the subscription simply ends. You may cancel at any time from your account; access continues until the end of the current billing period. In addition to your statutory rights, we offer a voluntary 30-day money-back guarantee: contact info@jazzchords.app within 30 days of your first payment for a full refund.',
    h_data: 'Your Data',
    p_data: 'You retain ownership of your practice data. We store it to provide the Service. You can export or delete your data at any time through your account settings. See our <a href="/privacy" class="underline">Privacy Policy</a> for details.',
    h_ip: 'Intellectual Property',
    p_ip: 'The Service, including its design, code, and educational content, is owned by Aaron Technologies OÜ. You may not copy, modify, or distribute any part of the Service without our written permission.',
    h_prohibited: 'Prohibited Conduct',
    p_prohibited: 'You agree not to:',
    li_prohibited_1: 'Use the Service for any illegal purpose',
    li_prohibited_2: 'Attempt to gain unauthorized access to our systems',
    li_prohibited_3: 'Interfere with the proper functioning of the Service',
    li_prohibited_4: 'Scrape, copy, or republish content from the Service',
    h_liability: 'Limitation of Liability',
    p_liability: 'The Service is provided "as is." To the maximum extent permitted by law, we shall not be liable for any indirect, incidental, or consequential damages arising from your use of the Service. This does not affect your statutory rights as a consumer under EU law.',
    h_termination: 'Termination',
    p_termination: 'We may suspend or terminate your access if you violate these Terms. You may delete your account at any time. Upon termination, your data will be deleted unless legally required to retain it.',
    h_changes: 'Changes to Terms',
    p_changes: 'We may update these Terms from time to time. We will notify registered users of material changes via email. Continued use after changes constitutes acceptance.',
    h_governing: 'Governing Law & Disputes',
    p_governing: 'These Terms are governed by Estonian law. For EU consumers, mandatory consumer protection laws of your country of residence apply. Disputes may be submitted to the EU Online Dispute Resolution platform at <a href="https://ec.europa.eu/consumers/odr/" target="_blank" rel="noopener noreferrer" class="underline">https://ec.europa.eu/consumers/odr/</a>.',
    h_contact: 'Contact',
    p_contact: 'For questions about these Terms, contact us at <a href="mailto:info@jazzchords.app" class="underline">info@jazzchords.app</a>.',
    h_withdrawal: 'Right of Withdrawal (EU)',
    p_withdrawal: 'As an EU consumer, you have the right to withdraw from a paid subscription within 14 days of purchase without giving a reason. To exercise this right, contact us at info@jazzchords.app. After withdrawal, we will reimburse all payments received from you.',
  },
  ...
  admin: {
    ...
    grant_title: 'Gift a membership',
    grant_desc: 'Grant a paid tier to any user by email — no Stripe charge. Useful for partners, testers, comps.',
    grant_email_placeholder: 'user@email.com',
    grant_cta: 'Gift tier',
    grant_revoke: 'Revoke',
    grant_done: 'Granted {tier} to {email}',
    grant_revoked: 'Revoked gifted membership from {email}',
    email: 'Email',
    joined: 'Joined',
    role: 'Role',
    tier: 'Tier',
  ...
  clock: {
    ...
    // Headings for the four places the dial appears in the product.
    results_title: 'The circle of fifths',
    results_sub: 'Lit up: the keys you just played.',
    setup_title: 'Where you stand',
    insights_title: 'Your keys',
    account_title: 'Circle of fifths',
    account_sub: 'How fast your hands find each key.',

    // Count — sits beside the dial where there is room.
    fluent_count: '{count} of 12 keys fluent',
    fluent_none: 'No key is fluent yet — play a session.',

    // The line after a session. Only when something actually crossed over.
    gained_one: '{key} is fluent — {before} → {after}',
    gained_one_fresh: '{key} is fluent — {after}',
    gained_many: '{keys} are fluent now.',
    milestone: '{count} of 12 keys fluent.',
    milestone_complete: 'All twelve keys are fluent.',
  },
