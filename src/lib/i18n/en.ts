export const en = {
  ...
  landing: {
    ...
    step1_title: 'See the chord',
    step1_desc: 'Your job: recall the shape and find it under your fingers — the exact skill real playing demands.',
    step1_chip1: 'Shells, rootless & more',
    step1_chip2: 'ii-V-I in all 12 keys',
    step2_title: 'Play it',
    step2_desc: 'Play the voicing and get instant feedback — right or wrong, every time. Connect a MIDI keyboard for auto-checking, or use your mic.',
    step2_chip1: 'Instant feedback',
    step2_chip2: 'MIDI, mic or tap',
    step3_title: 'Watch your weak keys disappear',
    step3_desc: 'The app tracks which keys slow you down and drills them harder. Session by session, the hesitation goes away.',
    step3_chip1: 'Weak-spot targeting',
    step3_chip2: 'Guided practice plans',
    bottom_cta_title: 'Ready to stop thinking and start playing?',
    bottom_cta_desc: 'No account. No install. Pick a chord and go.',
