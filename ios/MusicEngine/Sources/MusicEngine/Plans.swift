...
public let PRACTICE_PLANS: [PracticePlan] = [
    PracticePlan(id: "warmup", name: "plans.warmup_name", tagline: "plans.warmup_tagline", description: "plans.warmup_desc", icon: "☀️", accent: "var(--accent-amber)", level: .beginner,
    ...
    PracticePlan(id: "deepdive", name: "plans.deepdive_name", tagline: "plans.deepdive_tagline", description: "plans.deepdive_desc", icon: "🎯", accent: "var(--primary)", level: .intermediate,
        settings: PlanSettings(difficulty: .beginner, notation: .standard, voicing: .full, displayMode: .always, accidentals: .both, progressionMode: .oneSixTwoFive, totalChords: 48)),
    PracticePlan(id: "turnaround", name: "plans.turnaround_name", tagline: "plans.turnaround_tagline", description: "plans.turnaround_desc", icon: "🔄", accent: "var(--accent-purple)", level: .intermediate,
        settings: PlanSettings(difficulty: .beginner, notation: .standard, voicing: .shell, displayMode: .always, accidentals: .both, progressionMode: .oneSixTwoFive, totalChords: 48)),
    ...
    PracticePlan(id: "quartenzirkel", name: "plans.quartenzirkel_name", tagline: "plans.quartenzirkel_tagline", description: "plans.quartenzirkel_desc", icon: "🌀", accent: "var(--accent-amber)", level: .intermediate,
        settings: PlanSettings(difficulty: .beginner, notation: .standard, voicing: .halfShell, displayMode: .always, accidentals: .flats, progressionMode: .cycleOf4ths, totalChords: 12)),
    PracticePlan(id: "voicing-drill", name: "plans.voicing_drill_name", tagline: "plans.voicing_drill_tagline", description: "plans.voicing_drill_desc", icon: "🖐️", accent: "var(--primary)", level: .intermediate,
        settings: PlanSettings(difficulty: .beginner, notation: .standard, voicing: .root, displayMode: .always, accidentals: .both, progressionMode: .threeSixTwoFive, totalChords: 48)),
    PracticePlan(id: "left-hand-comping", name: "plans.left_hand_comping_name", tagline: "plans.left_hand_comping_tagline", description: "plans.left_hand_comping_desc", icon: "🤚", accent: "var(--accent-amber)", level: .advanced,
        settings: PlanSettings(difficulty: .beginner, notation: .standard, voicing: .rootlessA, displayMode: .always, accidentals: .both, progressionMode: .cycleOf4ths, totalChords: 48)),
    PracticePlan(id: "inversions-drill", name: "plans.inversions_drill_name", tagline: "plans.inversions_drill_tagline", description: "plans.inversions_drill_desc", icon: "🔃", accent: "var(--accent-purple)", level: .advanced,
        settings: PlanSettings(difficulty: .beginner, notation: .standard, voicing: .inversion1, displayMode: .always, accidentals: .both, progressionMode: .oneFourFive, totalChords: 36)),
    ...
    PracticePlan(id: "adaptive-drill", name: "plans.adaptive_drill_name", tagline: "plans.adaptive_drill_tagline", description: "plans.adaptive_drill_desc", icon: "🧠", accent: "var(--accent-purple)", level: .intermediate,
        settings: PlanSettings(difficulty: .intermediate, notation: .standard, voicing: .shell, displayMode: .always, accidentals: .both, progressionMode: .random, totalChords: 20)),
